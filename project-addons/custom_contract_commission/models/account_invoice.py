...
class AccountInvoice(models.Model):
    ...
    # Añado agents a la subfunción
    # Tuve que sobreescribirla entera, para quer al fusionar no se pierdan
    # las comisiones
    @api.multi
